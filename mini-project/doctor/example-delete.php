...
<div style="float:left;width: 50%;argin-left:40%;background-color: solid white;border-radius:20px;width:550px;border: 5px solid green;padding: 8px;">
...
?>
 ...
 <div style=" margin-top:%;margin-left:60%;background-color:solid white;border-radius:20px;  width: 500px; height:500px; border: 5px solid green;  padding:10px;overflow: scroll;">
<?php
