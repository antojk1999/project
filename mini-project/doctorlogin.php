                ...
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" action="configdoc.php" class="register-form" id="register-form">
							...
							<select name="state" style="width:250px;height:30px;margin-left:30px;cellspacing:50px;border:none;" >
                            ...
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                            <select name="district" style="width:250px;height:30px;margin-left:30px;cellspacing:50px;border:none;" required>
                            ...
                            <select name="hospital" style="width:250px;height:30px;margin-left:30px;cellspacing:50px;border:none;" required>
